...
class DoubleSum{
    ...
    public static void main(String[] args) {
        try(Scanner userInput = new Scanner(System.in)){
            ...
            BiPredicate<Double, Double> chekIfEven2 = (num1, num2) ->DoublePredicateDemo.sumIsEven(firstDouble, secondDouble);
            ...
            BiPredicate<Double, Double> chekIfEven3 = DoublePredicateDemo::sumIsEven;
            boolean result3 = chekIfEven2.test(firstDouble, secondDouble);
